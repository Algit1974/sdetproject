...
public class MensJacketsPage extends BasePage {
	...
	protected String noColorOption = "No color option";
	protected Map<ProductItem, Integer> cartItems = new HashMap<>();
	protected Map<ProductItem, Integer> itemsAddedInCurrentSession = new HashMap<>();
	protected Map<WebElement, String> sizeClickedForItem = new HashMap<>();  //To keep track of clicked size for an item
	protected Map<WebElement, String> colorClickedForItem = new HashMap<>(); //To keep track of clicked color for an item
...
public MensJacketsPage mouseOverMainMenuOption(String mainOption) {
	...
	mouseOverElement(option);
	activeMainMenuOption = option;
	
	return this;
}

public <E extends BasePage> E mouseOverMainMenuOptionAndClick(String mainOption) {
	mouseOverMainMenuOption(mainOption);
	activeMainMenuOption.click();
    switch(mainOption) {
    case("Men"): 
    	activeMainMenuOption = null;
    	return (E) new MensPage(driver); 
...
public <E extends BasePage> E mouseOverSubMenuOptionAndClick(String subOption) {
    ...
    case("Tops"): 
    	...
    	return (E) new MensTopsPage(driver); 
...
protected List<WebElement> getSizeOptions(WebElement item) {
...
protected List<WebElement> getColorOptions(WebElement item){
...
protected String getSelectedSize(WebElement element) {
...
protected String getItemName(WebElement item) {
	return item.findElement(By.xpath(".//div[@class='product-item-details']//a")).getText();
}
...
//for the item are selected.  This map represents the items that are added in the current session only.
